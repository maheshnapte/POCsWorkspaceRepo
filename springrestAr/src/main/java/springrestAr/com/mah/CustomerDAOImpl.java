...
public class CustomerDAOImpl implements CustomerDAO {
	 ...
	 * 
	 * //jdbcTemplate.up return jdbcTemplate.queryForObject(SQL_FIND_PERSON, new
	 * Object[] { id }, new PersonMapper()); }
	 * 
	 * public List<Person> getAllPersons() { List<Person> personList =
	 * jdbcTemplate.query(SQL_GET_ALL, new PersonMapper());
	 * System.out.println("personList: " + personList); return personList; }
	 */

	@Override
	public Customer getCustomerById(Integer id) {
		// TODO Auto-generated method stub
		// return jdbcTemplate.queryForObject(SQL_FIND_CUSTOMER, new Object[] { id },
		// new CustomrMapper());
		return null;
	}
